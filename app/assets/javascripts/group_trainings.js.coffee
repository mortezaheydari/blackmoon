...
$ ->
  ...
  $('input.location_gmap_check').click (e) ->
    if ($(@).is(':checked'))
        $(".g_rows").show()
        $("#personal_trainer_location_latitude").show()
        $("#personal_trainer_location_longitude").show()
        google.maps.event.trigger(map, 'resize')
    else
        $(".g_rows").hide()
        $("#personal_trainer_location_latitude").val("")
        $("#personal_trainer_location_longitude").val("")
        $("#personal_trainer_location_latitude").hide()
        $("#personal_trainer_location_longitude").hide()
